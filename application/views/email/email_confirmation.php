    ...
    <div class="container" style="max-width: 800px; margin: 0; padding: 30px 0;">
        <div class="text" style="height: 250px; width: 450px; font-weight: bold; text-align: left; margin: 100px 200px 50px 150px; font-size: 20.63px; font-family: "Ramaraja",regular;">
            <div>
                ...
                Atentie! Dupa activarea contului, vei fi directionat in santachat.ro, care de-acum va ramane pagina din care copilul ii va scrie Mosului. </br>
                Iar tu nu uita sa verifici casuta de mail, inclusiv in spam, ca sa citesti scrisorile copilului si sa-i raspunzi.  
               
            </div>
            <div>Iar daca link-ul de mai sus nu merge, atunci copiaza aceasta adresa in browser:</div>
