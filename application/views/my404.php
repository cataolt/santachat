...
<div class="light-blue">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <img src="<?php echo site_url();?>/../public/images/Sanie.png" class="img-responsive"/>
            </div>
            <div class="col-xs-12">
                <h1>
                    Ho, ho, hopaa !
                ...
                <h2>
                    S-a intampalt miracolul erorii 404...
                </h2>
                <h3>
                    verifica link-ul!
                </h3>
...
<script src="<?php echo site_url();?>/../public/plugins/bootstrap-3.3.6-dist/bootstrap-3.3.6-dist/js/bootstrap.min.js"></script>
</body>
