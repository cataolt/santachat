    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-lg-offset-4">
                <label>Hey Mos<?php echo $firstName;?>, te rugam sa introduci noua parola:</label>
                <?php
                ...
                <div class="form-group">
                    <?php echo form_password(array('name'=>'passconf', 'id'=> 'passconf', 'placeholder'=>'Rescrie parola', 'class'=>'form-control', 'value'=> set_value('passconf'))); ?>
